...
| 指标 | 结果 |
|---|---:|
| analysis_id | `firmware-static:7cd8331018a18819f875a63950f9f672e8d3ecbf5284ba9020cca6ca64d1fd29` |
| architecture | `riscv` |
| bit_width | `32` |
| endianness | `little` |
